            ...
            <div class="flex flex-col gap-4 p-6">
              ...
              <div class="flex gap-8">
                ...
                <div class="flex items-center gap-2">
                  <button id="add-to-watchlist" data-movie='${JSON.stringify(thisMovie, replacer)}'>
                  </button>
                  <label class="cursor-pointer" for="add-to-watchlist"> <svg class="h-5 w-5" width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
